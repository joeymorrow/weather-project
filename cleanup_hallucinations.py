...
def check_hallucination(text, date_str, item_type="pulse"):
    if item_type == "garage_sale":
        rules = "- Buddy acts as a local scout for garage sales. He searches for VERIFIABLE garage, yard, or estate sales happening today or tomorrow in Sault Ste. Marie, Michigan (Zip 49783). If the text mentions specific addresses, times, or sales that did not occur or are not scheduled, IT IS A HALLUCINATION. He must EXCLUDE Canadian garage sales (in Sault Ste. Marie, Ontario)."
        instructions = "1. Search Google to see if this specific garage/yard sale was advertised for this location and date in Michigan.\n2. If you cannot find any proof of a sale at this address/time, it is a hallucination.\n3. If the sale is located in Canada (Ontario), flag it as a hallucination.\n4. If the location/address provided is just a number without a street or road name, it is invalid and MUST be flagged as a hallucination."
