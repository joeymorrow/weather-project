...
def check_hallucination(text):
    prompt = f"""
You are a fact-checking assistant evaluating historical "Pulse" events for Sault Ste. Marie, Michigan. Use Google Search to verify if the event actually happened or was scheduled around the time it was reported before making a judgment.
